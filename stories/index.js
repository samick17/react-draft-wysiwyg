...
import CustomToolbar from './Customized/CustomToolbar';
import CustomHeader from './Customized/CustomHeader';
...
storiesOf('Custom - toolbar', module).add('story', () => <CustomToolbar />);
storiesOf('Custom - header', module).add('story', () => <CustomHeader />);